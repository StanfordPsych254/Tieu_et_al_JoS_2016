...
The key statistical test that will be a mixed-effects logistic regression with disjunction type as a fixed effect and with the random effects of subject and items. The DV has the two levesl of Right and Wrong.