...
participant_table <-
  original_data %>%
  group_by(Lang, AgeGroup, Complex) %>% # group participants based on language and age (adult vs. child)
...
plot_data$Complex <- as.factor(plot_data$Complex)
levels(plot_data$Complex) <- c("Simple","Complex")
